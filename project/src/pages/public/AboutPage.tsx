        ...
        <div className="container-app py-16">
          <div className="max-w-3xl">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xl text-primary-600 dark:text-primary-400">
                  Senior DevOps Engineer & Content Creator
                </p>
            ...
            <p className="mt-8 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              Passionate DevOps engineer with 6+ years of experience in building scalable infrastructure,
              automating deployment pipelines, and teaching cloud-native technologies. I created DevOpsBuilder
              to help aspiring engineers learn DevOps through practical tutorials and real-world projects.
            </p>
          </div>
        </div>
      </div>
